...
<body>
	<!-- 상단바 시작-->
	<table cellpadding="0" cellspacing="0" color="#a0a0a0" align="center" width="1536">
...
//기능구현에 필요한 전역 변수들
var CalendarDate='';//이렇게 값을 넣어주지 않으면 아래에서 사용할 때 오류가 발생한다.
var Arraymarkers=[]; //[]는 List다
var Arraycontents=[];
var Arrayinfowindows=[];
var MarkerObject={}; //{} key와 value로 이루어진 객체 (자바의 map과 비슷하다)
var ContentObject={};
	...
	function setMarker(listdate){//list형태의 json값을 for문으로 하나씩 가져와 Marker로만드는역할
		...
		for(let i=0;i<listdate.length;i++){ //let을 쓰거나 i대신 idx_setMarker같이 다른 함수에 의해 값이 변경될일이없는 복잡한이름으로 하기
			...
			Arraycontents[i] = [
				 '<div class="iw_inner">',
				    '   <table class="table">',
				    '   <tr><img src="/resources/upload/'+dog_photo+'" style="height:150px;" class="rounded-circle mx-auto d-block" alt="..."></tr>',
